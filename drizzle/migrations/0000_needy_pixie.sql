CREATE TYPE "public"."courseSection_statuses" AS ENUM('public', 'private');--> statement-breakpoint
...
CREATE TYPE "public"."user_roles" AS ENUM('users', 'admin');--> statement-breakpoint
...
CREATE TABLE "course_sections" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"name" text NOT NULL,
	"status" "courseSection_statuses" DEFAULT 'private' NOT NULL,
...
CREATE TABLE "users" (
	...
	"email" text NOT NULL,
	"name" text NOT NULL,
	"role" "user_roles" DEFAULT 'users' NOT NULL,
	"imageUrl" text,
