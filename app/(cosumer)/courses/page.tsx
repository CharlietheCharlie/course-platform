...
export default function CoursesPage() {
  return (
    <div className="container my-6">
      <PageHeader title="My Courses"></PageHeader>
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        <Suspense
          fallback={
            <SkeletonArray amount={3}>
              <SkeletonCourseCard></SkeletonCourseCard>
            </SkeletonArray>
          }
        >
...
function SkeletonCourseCard() {
  return <Card>
    <CardHeader>
      ...
      <CardDescription>
        <CardTitle>
          <SkeletonText className="w-1/2"></SkeletonText>
        </CardTitle>
      </CardDescription>
    </CardHeader>
    <CardContent>
      <SkeletonText rows={3}></SkeletonText>
    </CardContent>
    <CardFooter>
      <SkeletonButton />
    </CardFooter>
...
async function getUserCourses({ userId }: { userId: string }) {
  "use cache";
